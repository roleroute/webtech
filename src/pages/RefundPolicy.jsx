        ...
        <div className='PrivacyPolicy'>
            ...
            <ul>
                ...
                <li>
                    ...
                    <li><br/>
                    3. In case of complaints regarding the products that come with a warranty from the manufacturers,
                    please refer the issue to them.</li>
                    <li><br/>
                    4.In case of any refunds approved by <b>Webtechage Private Limited,</b> it will take <b>7 days</b> for the
