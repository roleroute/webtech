...
const RefundPolicy = () => {
    return (
        <div className='PrivacyPolicy'>
            <h1>WEBTECHAGE PRIVATE LIMITED REFUND AND CANCELLATION POLICY</h1>
            ...
            <ul>
                <li>
                    1.Cancellations will only be considered if the request is made <b>7 days</b> of placing the order. However,
                ...
                <li>
                    2. <b>Webtechage Private Limited</b> does not accept cancellation requests for perishable items like
                    flowers, eatables, etc. However, the refund / replacement can be made if the user establishes that
                    the quality of the product delivered is not good. </li><br/>
                <li>
                    ...
                    <li><br/>
                    5.In case of any refunds approved by <b>Webtechage Private Limited,</b> it will take <b>7 days</b> for the
